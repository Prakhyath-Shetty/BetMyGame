                ...
                >
                  <div className="row">
                            ...
                            <div className="col-md-11 mx-auto">
                              <div className="form-group">
                                ...
                                >
                                  ...
                                  designs. My job is to build your website so
                                  that it is functional and user-friendly but at
                                  the same time attractive. Moreover, I add
                                  personal touch to your product and make sure
                                  that is eye-catching and easy to use. My aim
                                  is to bring across your message and identity
                                  in the most creative way. I created web design
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                      <form
                        id="work-platforms"
                        className="section work-platforms"
                      >
                        <div className="info">
                      ...
                      <div id="skill" className="section skill">
                        <div className="info">
                          ...
                          <div className="row progress-bar-section">
                            ...
                            <div className="col-md-11 mx-auto">
                              <div
                                className="custom-progress top-right progress-up"
                                style={{ width: "100%" }}
                              >
                    ...
                    <div className="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                      <form
                        id="edu-experience"
                        className="section edu-experience"
                      >
                        <div className="info">
              ...
              <div className="account-settings-footer">
                <div className="as-footer-container">
                  ...
                  <div className="blockui-growl-message">
                    <i className="flaticon-double-check"></i>&nbsp; Settings
                    Saved Successfully
                  </div>
