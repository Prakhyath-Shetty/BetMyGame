        ...
        <div id="content" className="main-content">
                ...
                <div className="bio layout-spacing ">
                  <div className="widget-content widget-content-area">
                    ...
                    <p>
                      ...
                      nascetur ridiculus mus. Nunc ut velit finibus, scelerisque
                      sapien vitae, pharetra est. Nunc accumsan ligula vehicula
                          ...
                          <div className="d-flex b-skills">
                            ...
                            <div className="">
                              ...
                              <p>
                                ...
                                exercitation aliquip ex ea commodo consequat.
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <div className="footer-wrapper">
            <div className="footer-section f-section-1">
              <p className="">
                Copyright © 2020{" "}
                <a href="https://designreset.com">DesignReset</a>, All rights
                reserved.
              </p>
            </div>
