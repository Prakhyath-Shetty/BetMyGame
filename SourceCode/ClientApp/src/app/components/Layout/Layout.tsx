    ...
    <React.Fragment>
      ...
      <div id="appCapsule">
        ...
        <div className="section full mt-3 mb-3">
          <div className="carousel-multiple owl-carousel owl-theme">
            ...
            <div className="item">
              <div className="card">
                <img
                  src="assets/img/sample/photo/d2.jpg"
                  className="card-img-top"
                  alt="image"
                />
                <div className="card-body pt-2">
            ...
            <div className="item">
              <div className="card">
                <img
                  src="assets/img/sample/photo/d3.jpg"
                  className="card-img-top"
                  alt="image"
                />
                <div className="card-body pt-2">
            ...
            <div className="item">
              <div className="card">
                <img
                  src="assets/img/sample/photo/d4.jpg"
                  className="card-img-top"
                  alt="image"
                />
                <div className="card-body pt-2">
            ...
            <div className="item">
              <div className="card">
                <img
                  src="assets/img/sample/photo/d6.jpg"
                  className="card-img-top"
                  alt="image"
                />
                <div className="card-body pt-2">
            ...
            <div className="item">
              <div className="card">
                <img
                  src="assets/img/sample/photo/d5.jpg"
                  className="card-img-top"
                  alt="image"
                />
                <div className="card-body pt-2">
        ...
        <div className="section mt-3 mb-3">
          <div className="card">
            <img
              src="assets/img/sample/photo/wide4.jpg"
              className="card-img-top"
              alt="image"
            />
        ...
        <div className="section mt-3 mb-3">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Mobilekit comes with basic pages you may need and use in your
                projects easily.
              </p>
