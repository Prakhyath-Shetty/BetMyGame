 ...
 * starting position
 */
export function startPoint(seedId: any) {
 ...
 */
export function newSeedPosition(seedId: any, currentSeedPosition: any) {
  let newPosition;
 ...
 */
function hlPath(seedId: any, currentSeedPosition: any) {
  let newPosition;
 ...
 * first row(HL-0).
 */
function hlZeroPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
  if (increment === 5) {
    newPosition = "VT-50";
  } else {
 ...
 * second row(HL-1).
 */
function hlOnePath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
 ...
 * third row(HL-2).
 */
function hlTwoPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
  if (increment === 0) {
    newPosition = "HL-10";
 ...
 * top vertical rail.
 */
function vtPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    match = `${currentSeedPosition.substr(0, 3)}${currentSeedPosition.substr(
      4,
      1
    )}`;
  switch (match) {
 ...
 * the (*) was removed.
 */
function vtZeroPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
  if (increment === 0) {
    newPosition = "VT-01";
  } else {
 ...
 * the (*) was removed.
 */
function vtOnePath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
 ...
 * the (*) was removed.
 */
function vtTwoPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
  if (increment === 5) {
    newPosition = "HR-00";
 ...
 * horizontal rail.
 */
function hrPath(seedId: any, currentSeedPosition: any) {
  let newPosition;
  switch (currentSeedPosition.substr(0, 4)) {
    case "HR-0":
 ...
 * of the HR rail(HR-0).
 */
function hrZeroPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
  if (increment === 5) {
    newPosition = "HR-15";
 ...
 * of the HR rail(HR-1).
 */
function hrOnePath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
 ...
 * of the HR rail(HR-2).
 */
function hrTwoPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(4, 1), 10);
  if (increment === 0) {
    newPosition = "VB-02";
 ...
 * rail.
 */
function vbPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    match = `${currentSeedPosition.substr(0, 3)}${currentSeedPosition.substr(
      4,
      1
 ...
 * the (*) was removed.
 */
function vbZeroPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
  if (increment === 0) {
    newPosition = "HL-25";
 ...
 * the (*) was removed.
 */
function vbOnePath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
 ...
 * the (*) was removed.
 */
function vbTwoPath(seedId: any, currentSeedPosition: any) {
  let newPosition,
    increment = parseInt(currentSeedPosition.substr(3, 1), 10);
  if (increment === 5) {
    newPosition = "VB-51";
